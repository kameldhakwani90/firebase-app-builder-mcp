...
- Nom: ${projectName}
- Path: ${projectPath}
- Fichier types.ts: ${JSON.stringify(files.types, null, 2).substring(0, 1000)}...
- Fichier data.ts: ${JSON.stringify(files.mockData, null, 2).substring(0, 1000)}...
- Blueprint: ${files.blueprint?.rawContent?.substring(0, 500)}...
